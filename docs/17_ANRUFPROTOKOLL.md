...
- Adresse: Straße mit Hausnummer, auch „Kaiser-Str. 12“ oder „Kaiser Straße 12a“; nach „am“, „an der“, „in der“ und ähnlichen auch ohne Straßen-Endung („Am Stadtgarten 5“, „an der Alten Post 12“); das Wort „Hausnummer“; eine Postleitzahl vor einem Ort. Ein Stadtteil ist erlaubt, eine Zahl vor „Uhr“, „Personen“ oder „mal“ gilt nicht als Hausnummer
- Allergie: „Allergie“ (auch „Nussallergie“), „allergisch“, „Unverträglichkeit“, „Intoleranz“, „Allergien gegen …“ und „Allergien“ mit Personenbezug („ich habe Allergien“, „mein Sohn hat Allergien“); die Frage nach „Allergenen“ oder „Allergien“ eines Gerichts ist erlaubt
...
Name und Rufnummer stehen nie im Protokoll, der Agent braucht beide vor `confirm`. Ein Fall mit `confirmed: true` bekommt deshalb die erfundene `caller_id` `+497215551234` (Beispielnummer aus `docs/08` §1) und zwei erfundene Zeilen im `transcript`: „Auf den Namen Mueller.“ und „Ja, das passt.“. Das Ja steht fest am Ende, weil der letzte Satz im Protokoll nicht immer eine Bestätigung ist („Danke“). Die nachgestellten Kundensätze kommen davor. Die ID enthält die Minute; eine doppelt abgetippte Zeile ergibt einen Fall, nicht zwei.
