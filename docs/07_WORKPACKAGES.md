...
| T-4.11 | - | Umwandler Kasse → Importformat: liest Kopien von `Artikel.dbf`, `WarenGRP.dbf`, `Zutaten.dbf`, `ZutatenGRP.dbf` nur lesend und schreibt die CSV-Dateien nach 14; Platzhalterzeile `000` raus, abgeschnittene Namen und Allergen-Luecken als Warnung, Artikelnummer der Kasse in Originalschreibweise erhalten | 14 §Quelle Kasse | T-4.2, alle Spalten der Zutaten-Dateien, 01 D11 | offen |
