...
Trage den Block zusätzlich oben in den Abschnitt „Erledigt" von `docs/01_STATUS.md` ein (Kurzform, eine Zeile) und prüfe, dass „Was als Nächstes dran ist" stimmt.
