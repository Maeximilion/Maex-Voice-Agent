...
- Erste Tools im heißen Pfad, beide mit Latenztest gegen das 300-ms-Budget: `POST /v1/tools/get_service_status` beantwortet aus der Datenbank, ob und was gerade geht (Öffnungszeiten, Sondertage, Wartezeiten, Modus); `POST /v1/tools/check_slot` prüft einen Reservierungswunsch gegen Kapazität und Öffnungszeit und nennt bis zu zwei Alternativen
